            ...
            <div className="grid  grid-cols-1 gap-8 px-14 lg:px-4 lg:py-8 lg:grid-cols-4 py-20        ">
                <div className=" flex-col flex mb-2  md:mb-0 md:items-center ">
                    <img
                        ...
                        src="https://i.ibb.co.com/mrGXHT1Y/transparent-Photoroom-1-2.png" alt="" />
                    <h3 className='font-semibold text-secondary mb-3'>Plate <span className='text-primary'>Share</span></h3>
                    <div className="flex gap-4 items-center">


                        <a className='p-2 border-2 rounded-full text-primary hover:text-white hover:bg-primary'
                            href="">
                            <svg
                                stroke="currentColor"
                                fill="currentColor"
               ...
               124.72v70.62H22.89V288h81.39v224h100.17V288z"></path>
                ...
                <div className="">
                    <h3 className='text-secondary font-bold  first:uppercase'>Informations
                    </h3>
